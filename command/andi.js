...
//const prem = require('./message/premium')
...
const _registered = JSON.parse(fs.readFileSync('./registered.json'))
const register = JSON.parse(fs.readFileSync('./registered.json'))
// HOST WHM
...
//Premium Exp
//prem.expiredCheck(Andi, m, premium);
...
: ((user.exp >= 4700) && (user.exp <= 4900)) ? 'GrandMaster ①'

: ((user.exp >= 4900) && (user.exp <= 5100)) ? 'GrandMaster ②'
...
countDownDate = new Date("2023-03-23").getTime();
var now = new Date().getTime();
var distance = countDownDate - now;
var dayss = Math.floor(distance / (1000 * 60 * 60 * 24));
var hourss = Math.floor((distance % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
...
fs.writeFileSync('./registered.json', JSON.stringify(_registered))
}
...
let buttons = [{ buttonId: '.menu', buttonText: { displayText: 'List Fitur' }, type: 1 }]
            let buttonMessage = {
  ...
  title: `${ucapanWaktu}`,
  body: `Hai kak ${db.data.users[m.sender].nama}...`, 
  ...
  Andi.sendMessage(m.chat, buttonMessage, {quoted: ftroli})
            }
            break
...
let buttons = [{ buttonId: '.menu', buttonText: { displayText: 'List Fitur' }, type: 1 }]
  ...
  Andi.sendMessage(m.chat, buttonMessage, {quoted: ftroli})
            ...
            break
case 'allmenu': {
if (!db.data.users[m.sender].daftar) return Andi.sendButtonText(m.chat, [{ buttonId: 'Daftar', buttonText: { displayText: 'DAFTAR' }, type: 1 }], `「 REGISTRASI 」\n\nSilahkan Daftar Terlebih Dahulu\nTekan button dibawah atau ketik #daftar`, creator, m)
...
'buttons':buttons,
'headerType':6}
    await Andi.sendMessage(m.chat,buttonMessage, { quoted:ftroli})
}
...
const tessgh = await Andi.sendMessage(m.chat, listMessage, { quoted: ftroli })
}
break
case 'funmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, funmenu, creator, m, { quoted: ftroli })
            }
            break
case 'groupmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, group, creator, m, { quoted: ftroli })
            }
            break
            case 'textpromenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, convermenu, creator, m, { quoted: ftroli })
            }
            break
case 'randommenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, rm, creator, m, { quoted: ftroli })
            }
            break
case 'downloadmenu': {
if(!db.data.users[m.sender].premium)throw`Fitur Ini Khusus Untuk Premium`
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, downloadme, creator, m, { quoted: ftroli })
            }
            break
case 'ownermenu': {
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, ownerme, creator, m, { quoted: ftroli })
            }
            break
case 'anonymousmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, cht, creator, m, { quoted: ftroli })
            }
            break
case 'databasemenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, dbm, creator, m, { quoted: ftroli })
            }
            break
case 'islamicmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Owner' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, islmm, creator, m, { quoted: ftroli })
            }
            break
case 'chargermenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, chargermenu, creator, m, { quoted: ftroli })
            }
            break
case 'makermenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, mkrmnu, creator, m, { quoted: ftroli })
            }
            break
case 'bugmenu': {
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, bug, creator, m, { quoted: ftroli })
            }
            break
case 'soundmenu': {
if (!db.data.users[m.sender].premium) throw mess.prem
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, sm, creator, m, { quoted: ftroli })
            }
            break
case 'donasi': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
await Andi.sendButtonText(m.chat, buttons, donasi, creator, m, { quoted: ftroli })
}
break
case 'mainmenu': {
let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `${global.fake}`,jpegThumbnail: global.thumb}}}
...
╚━❖`
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️BACK MENU' }, type: 1 },{ buttonId: 'rules', buttonText: { displayText: 'RULES BOT' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'OWNER' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, mainmenu, creator, m, { quoted: ftroli })
            }
break
case 'unreg': {
...
let buttons = [{ buttonId: 'menu', buttonText: { displayText: '️Back Menu' }, type: 1 },{ buttonId: 'ping', buttonText: { displayText: 'Status Bot' }, type: 1 },{ buttonId: 'owner', buttonText: { displayText: 'Owner' }, type: 1 }]
            await Andi.sendButtonText(m.chat, buttons, source, creator, m, { quoted: ftrolii })
            }
break
case 'revoke': {
...
Andi.sendMessage(m.chat, { text: teks, mentions: participants.map(a => a.id) }, { quoted: ftroli })
}
break
case 'hidetag': {
if (!m.isGroup) throw mess.group
if (!isBotAdmins) throw mess.botAdmin
if (!isAdmins) throw mess.admin
Andi.sendMessage(m.chat, { text : q ? q : '' , mentions: participants.map(a => a.id)}, { quoted: ftroli })
}
...
case 'ffcover': case 'crossfire': case 'galaxy': case 'glass': case 'neon': case 'beach': case 'igcertificate': case 'ytcertificate': {
                ...
                m.reply(mess.wait)
                Andi.sendMessage(m.chat, { image: { url: api('Andi', '/ephoto/' + command, { text: text }, 'apikey') }, caption: `Ephoto ${command}` }, { quoted: m })
            }
            break
...
case 'couple': {
                ...
                Andi.sendMessage(m.chat, { image: { url: random.male }, caption: `Couple Male` }, { quoted: ftroli })
                Andi.sendMessage(m.chat, { image: { url: random.female }, caption: `Couple Female` }, { quoted: ftroli })
            }
        break
case 'family100': {
...
let msg = await Andi.sendMessage(m.chat, { audio: { url: result.link_song }, mimetype: 'audio/mpeg' }, { quoted: ftroli })
...
+ `END:VCARD`
let msg = await Andi.sendMessage(m.chat, { contacts: { displayName: `${owner}`, contacts: [{ vcard }] } }, { quoted: ftroli })
let buttons3 = [
...
Andi.sendMessage(m.chat, buttonMessage3, { quoted: ftroli })                        
}
break
...
Andi.sendMessage(m.chat, { image: buffer }, { quoted: ftroli })
fs.unlinkSync(ran)
})
}
break
...
case 'ai': case 'openai': case 'ngobrol':
    if (!db.data.users[m.sender].premium) throw mess.prem
let ai = await fetchJson(`https://api.zahwazein.xyz/entertainment/openai?query=${text}&apikey=8d66b4b4aa`)
...
Andi.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${Andi.user.name}.mp3`}, { quoted: ftroli })
}
break
...
await Andi.sendMessage(m.chat, { video: { url: webpToMp4.result, caption: 'Convert Webp To Video' } }, { quoted: ftroli })
...
case 'pinterest': {
  ...
  Andi.sendMessage(m.chat, { image: { url: result }, caption: 'Source Url : '+result, buttons: buttonspinterest }, { quoted: ftroli })
  }
  break
case 'wallpaper': {
  if (!text) return m.reply(`Mau Cari Apa Di ${command}?\nExample : *${prefix + command} hinata*`)
  ...
  Andi.sendMessage(m.chat, { image: { url: result.image[0] }, caption: `Source Url : ${result.image[2] || result.image[1] || result.image[0]}`, buttons: buttonswallpaper }, { quoted: ftroli })
  }
  break
case 'quotesanime': {
  m.reply(mess.wait)
...
case 'iqra': {
		...
		if (args[0] === 'pdf') {
		m.reply(mess.wait)
		Andi.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/json/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:m})
		} else if (args[0] === 'docx') {
		m.reply(mess.wait)
		Andi.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/json/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:m})
		} else if (args[0] === 'pptx') {
		m.reply(mess.wait)
		Andi.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/json/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:m})
		} else if (args[0] === 'xlsx') {
		m.reply(mess.wait)
		Andi.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/json/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
...
let buttonMessage = {
                ...
                Andi.sendMessage(m.chat, buttonMessage, { quoted: ftroli })
Andi.sendMessage(m.chat, { audio: { url: resi.audio.audio }, mimetype: 'audio/mpeg'}, { quoted: ftroli })
  break
case 'yts': case 'ytsearch':{
m.reply(mess.wait)
if (!text) throw `Contoh : ${prefix + command} dj tiktok`
eresi = await fetchJson(`https://saipulanuar.ga/api/yt/search?query=${text}`)
let buttonnsi = [{ buttonId: 'menu', buttonText: { displayText: '️MENU' }, type: 1 }]
let hhhi = { url : eresi.result.image }
let teks = '*---- Data Ditemukan ----*\n\n Keywords : '+text+'\n\n'
  let no = 1
  teks += `🔢 No : ${no++}
🎞️ Type : ${eresi.result.type}
📀 Video ID : ${eresi.result.videoId}
📄 Title : ${eresi.result.title}
👁️ Views : ${eresi.result.views}
👁️ Duration : ${eresi.result.timestamp}
📤 Upload : ${eresi.result.ago}
👨‍🎤 Author : ${eresi.result.author.name}
🔗 Url : ${eresi.result.url}\n\n━━━━━━━━━━━━━━━━━\n\n`
let buttonMessage = {
                    image: hhhi,
                    caption: teks,
                    footer: "copyright © 2023•𝐀𝐧𝐝𝐢𝐆𝐚𝐧𝐬",
...
let buttonMessage = {
                ...
                Andi.sendMessage(m.chat, buttonMessage, { quoted: ftroli })
Andi.sendMessage(m.chat, { audio: { url: eresi.result.url }, mimetype: 'audio/mpeg'}, { quoted: ftroli })
}
    break
...
case 'tiktokmp3': case 'tiktokaudio': {
                ...
                Andi.sendMessage(m.chat, { audio: { url: anu.result.audio }, mimetype: 'audio/mpeg'}, { quoted: ftroli })
            }
            break
...
Andi.sendMessage(m.chat, { video: { url: alnu.result.url }, mimetype: 'video/mp4', fileName: `${text}.mp4`, caption: `*INSTAGRAM VIDEO* \nCopyright © 𝐀𝐧𝐝𝐢𝐆𝐚𝐧𝐬` }, { quoted: m })
    ...
    break
            case 'joox': case 'jooxdl': {
                ...
                m.reply(mess.wait)
                let anu = await fetchJson(api('Andi', '/downloader/joox', { query: text }, 'apikey'))
            ...
            case 'soundcloud': case 'scdl': {
                ...
                if (!text) throw 'No Query Title'
                m.reply(mess.wait)
                let anu = await fetchJson(api('Andi', '/downloader/soundcloud', { url: isUrl(text)[0] }, 'apikey'))
                await Andi.sendImage(m.chat, anu.result.thumb, `⭔ Title : ${anu.result.title}\n⭔ Url : ${isUrl(text)[0]}`)
                AndisendMessage(m.chat, { audio: { url: anu.result.url }, mimetype: 'audio/mpeg', fileName: anu.result.title+'.m4a' }, { quoted: ftroli })
            }
            break
	        ...
	        if (!db.data.users[m.sender].premium) throw mess.prem
                if (!text) throw 'Masukkan Query Link!'
                m.reply(mess.wait)
                let anu = await fetchJson(api('Andi', '/api/downloader/twitter', { url: text }, 'apikey'))
                let buttons = [
		    ...
		    image: { url: anu.result.thumb },
                ...
                await Andi.sendMessage(m.chat, buttonMessage, { quoted: m })
                Andi.sendMessage(m.chat, { audio: { url: anu.result.audio } }, { quoted: ftroli })
            }
            break
...
Andi.sendMessage(m.chat, { video: { url: almnu.result.hd }, mimetype: 'video/mp4', fileName: `${text}.mp4`, caption: `*FACEBOOK VIDEO* \nCopyright © 𝐀𝐧𝐝𝐢𝐆𝐚𝐧𝐬` }, { quoted: m })
    ...
    break
	        ...
	        if (!db.data.users[m.sender].premium) throw mess.prem
                ...
                Andi.sendMessage(m.chat, { video: { url: anu.result }, caption: `Download From ${text}` }, { quoted: ftroli })
            }
            break
...
case 'menfes': case 'menfess': { 
            ...
            await Andi.sendButtonText(m1 + '@s.whatsapp.net', buttons, pjtxt, kawk, m, {mentions: ments, quoted: ftroli})
            let akhji = `Pesan Telah Terkirim\nKe @${mq1.split('@')[0]}`
            await Andi.sendButtonText(m.chat, buttons, akhji, creator, m, {mentions: ments, quoted: ftroli})
            }
            break
case 'menfessconfirm':
...
case 'runtime': case 'tes': {
                ...
                await Andi.sendButtonText(m.chat, buttons, lowq, creator, m, { quoted: ftroli })
                }
            break
case 'setmenu': {
            if (!isCreator) throw mess.owner
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'gambar'){
                ...
                rows: [
                {title: "Template Image", rowId: `setmenu gambar`, description: `Change menu bot to Template Image`},
                {title: "Template Doc", rowId: `setmenu doc`, description: `Change menu bot to Template doc`}
                ]
                },
                ]
...
break
            ...
            case 'tukar': {
               if (args[0] === 'premium'){
                ...
                m.reply('Sukses tukar ke premium')
                } else if (args[0] === 'uang'){
                if (global.db.data.users[m.sender].saldo < 5000) return m.reply('Saldo Kamu Tidak Cukup!!')
                db.data.users[m.sender].saldo -= 5000
...
case 'listharga':
			...
			case 'pricelist': {
				...
				Andi.sendMessage(m.chat, {text: list}, {quoted:m})
				console.log(feta)
				}
				break*/
case 'chekstatus':
...
//------------------< Premium >-------------------
       /*case 'addprem':
				...
				Andi.sendMessage(m.chat, { text: "Sukses Premium" }, { quoted: fkontak });
					} else {
				prem.addPremiumUser(args[0] + "@s.whatsapp.net", args[1], premium);
				Andi.sendMessage(m.chat, { text: "Sukses Via Nomor" }, { quoted: fkontak });
						}
					}
				break
			case 'delprem':
				...
				if (m.mentionedJid.length !== 0) {
					...
					Andi.sendMessage(m.chat, { text: "Sukses Delete" }, { quoted: fkontak });
				} else {
				premium.splice(prem.getPremiumPosition(args[0] + "@s.whatsapp.net", premium), 1);
				fs.writeFileSync("./json/premium.json", JSON.stringify(premium));
				Andi.sendMessage(m.chat, { text: "Sukses Via Nomer" }, { quoted: fkontak });
				}
				}
				break
		case 'listprem': {
			if (!isCreator) return m.reply(mess.owner)
			let data = require("./json/premium.json")
...
case 'proses':
            ...
            Andi.sendMessage(`6285737134572@s.whatsapp.net`, {text: proses })
            break
        case 'done':
            if (!isCreator) return
...
Andi.sendMessage(m.chat, { image: { url: random }, caption: `Nih Kak` }, { quoted: ftroli })
}
break
// BROADCAST
case 'bctext':{
...
case 'kirimkann': case 'kirimkan': { 
		        if (!isCreator) return m.reply(mess.owner)
		        if (m.isGroup) throw ('fitur tidak dapat digunakan di grup')
            	if (!text) throw `Example : ${prefix + command} 62858xxxxx|button|pesan`
            var mon = args.join(' ')
            var m1 = mon.split("|")[0]
            var m2 = mon.split("|")[1]
            var m3 = mon.split("|")[2]
               let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `Softbots Official Whatsapp`,jpegThumbnail: global.thumb}}}
               let mq1 = m1 + '@s.whatsapp.net'
            ...
            case 'kirimkann2': case 'kirimkan2': { 
		        if (!isCreator) return m.reply(mess.owner)
		        if (m.isGroup) throw ('fitur tidak dapat digunakan di grup')
            	if (!text) throw `Example : ${prefix + command} id grup|button|pesan`
            var mon = args.join(' ')
            var m1 = mon.split("|")[0]
            var m2 = mon.split("|")[1]
            var m3 = mon.split("|")[2]
               let kafloc = {key : {participant : '0@s.whatsapp.net', ...(m.chat ? { remoteJid: `status@broadcast` } : {}) },message: {locationMessage: {name: `WhatsApp`,jpegThumbnail: global.thumb}}}
               let mq1 = m1 + '@g.us'
...
Andi.sendText(m.chat, `"Waalaikumsalam warahmatullahi wabarakatuh"`, { quoted: kafloc })
}
break
case 'p':{
Andi.sendText(m.chat, `"Salam dulu kak, sesuai agama masing masing"`, { quoted: kafloc })
}
break
case 'hai': case 'hii': case 'hi': case 'halo': case 'hallo': case 'hello': case 'haii':{
Andi.sendText(m.chat, `"${command} juga👋, Ada yang bisa gw bantu?"`, { quoted: kafloc })
}
break
//━━━━━━━━━━━━━━━[ AKHIR FITUR ]━━━━━━━━━━━━━━━━━//
...
Andi.sendMessage(m.chat, reactionMessage)
}*/
